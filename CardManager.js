...
console.log(intersects);
    ...
    // 都道府県に対応する比例ブロックを返すメソッド
    addProportionalBlock(prefectureKey) {
        const proportionalBlocks = {
            "比例北海道ブロック": ["北海道"],
            "比例東北ブロック": ["青森県", "岩手県", "宮城県", "秋田県", "山形県", "福島県"],
            "比例北関東ブロック": ["茨城県", "栃木県", "群馬県", "埼玉県"],
            "比例南関東ブロック": ["千葉県", "神奈川県", "山梨県"],
            "比例東京ブロック": ["東京都"],
            "比例北陸信越ブロック": ["新潟県", "富山県", "石川県", "福井県", "長野県"],
            "比例東海ブロック": ["岐阜県", "静岡県", "愛知県", "三重県"],
            "比例近畿ブロック": ["滋賀県", "京都府", "大阪府", "兵庫県", "奈良県", "和歌山県"],
            "比例中国ブロック": ["鳥取県", "島根県", "岡山県", "広島県", "山口県"],
            "比例四国ブロック": ["徳島県", "香川県", "愛媛県", "高知県"],
            "比例九州・沖縄ブロック": ["福岡県", "佐賀県", "長崎県", "熊本県", "大分県", "宮崎県", "鹿児島県", "沖縄県"]
        };

        // ループで対応する比例ブロックを検索
        for (const [block, prefectures] of Object.entries(proportionalBlocks)) {
            if (prefectures.includes(prefectureKey)) {
                return block;  // マッチする比例ブロック名を返す
            }
        }
